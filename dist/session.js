...
import { loadProjectConfig, projectPromptSection, } from "./projectConfig.js";
...
export class Session {
    allocator = new PlaceholderAllocator();
    project;
    history;
    constructor(project = loadProjectConfig()) {
    ...
    async anonymizeUserMessage(content) {
